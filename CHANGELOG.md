## 3.6-4.2.1 2026-04-29 <code at nfrastack dot com>
...
## 3.6-4.1.14 2026-03-26 <code at nfastack dot com>

   ### Added
      - Traefik 3.6.12


## 3.6-4.1.13 2026-03-19 <code at nfastack dot com>

   ### Added
      - Traefik 3.6.11


## 3.6-4.1.12 2026-03-07 <code at nfastack dot com>

   ### Added
      - Traefik 3.6.10


## 3.6-4.1.11 2026-02-23 <code at nfastack dot com>

   ### Added
      - Traefik 3.6.9
      - Traefik Certificate Dumper 2.11.0


## 3.6-4.1.10 2026-02-11 <code at nfastack dot com>
...
## 3.6-4.1.6 2025-12-08 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.6.4


## 3.6-4.1.5 2025-11-18 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.6.2


## 3.6-4.1.4 2025-11-13 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.6.1


## 3.6-4.1.3 2025-11-07 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.6.0


## 3.5-4.1.2 2025-11-07 <dave at tiredofit dot ca>
...
## 3.5-4.1.0 2025-09-26 <code at nfrastack dot com>
   ...
   ### Added
      - HTTP(s)_COMPRESSION_INCLUDE|EXCLUDE environment variables
      - HTTP(s)_COMPRESSION_MINIMUM_RESPONSE_BODY_BYTES variables

   ### Changed
      - Patchup compression middleware routines
...
## 3.4-3.4-3.3 2025-07-23 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.4.5


## 3.4-3.4-2.44 2025-07-11 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.4.4


## 3.4-2.43.0 2025-06-26 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.4.3


## 3.4-2.41.0 2025-05-27 <dave at tiredofit dot ca>
...
## 3.3-3.3-2.37 2025-05-05 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.3.7


## 3.3-2.36 2025-04-18 <dave at tiredofit dot ca>
...
## 3.3-2.33 2025-02-25 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.3.4


## 3.3-2.32 2025-01-31 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.3.3


## 3.3-2.31 2025-01-07 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.3.1


## 3.3-2.30 2025-01-06 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.3.0


## 3.2-2.29 2025-01-06 <dave at tiredofit dot ca>
...
## 3.1-2.24 2024-10-28 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.1.7


## 3.1-2.23 2024-10-09 <dave at tiredofit dot ca>

   ### Added
      - Traefik 3.1.6


## 3.1-2.22 2024-10-02 <dave at tiredofit dot ca>
